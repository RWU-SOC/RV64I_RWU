...
HD_PWD='/home/abhishek-revoor/Desktop/Thesis/rwu-rv64i-master/Vivado/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log as_top_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source as_top_mem.tcl
