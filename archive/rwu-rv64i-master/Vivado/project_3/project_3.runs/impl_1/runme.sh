...
HD_PWD='/home/abhishek-revoor/Desktop/Thesis/rwu-rv64i-master/Vivado/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log as_top_mem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source as_top_mem.tcl -notrace
